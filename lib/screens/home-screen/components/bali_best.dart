...
class BaliDestination extends StatelessWidget {
  final Map<String, dynamic> baliList;
  const BaliDestination({Key? key, required this.baliList}) : super(key: key);
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                      fit: BoxFit.cover, image: NetworkImage("${baliList['image']}"))),
            ),
            Container (
